...
Contrôle des permissions & Dépendance FastAPI \texttt{AdminUser} = \texttt{Annotated[..., Depends(require\_admin)]}, isolation inter-utilisateurs testée (\texttt{test\_orders\_cross\_user\_isolation}) \\
...
Maquettage UI et enchaînement des écrans & Première version des maquettes sous Figma Make (cf. mémoire), écrans finalisés directement en développement au fil des sprints \\
...
Plan et campagne de tests & 99 tests automatisés (68 backend + 31 frontend), couverture pytest par module, jeu d'essai détaillé sur les deux parcours les plus représentatifs (commande/paiement, scan ISBN) \\
